...
parse a text file to extract skills on the sea of corporate buzzwords
copy it directly to the clipboard
ready to be pasted to the CsvOfDisappointment.csv
eliminates manual parsing and typing of skills
  ...
  PROCESS {
    ...
    if (Test-Path $FilePath) {
      ...
      if ($FoundSkills) {
        ...
        Write-Host "    $CleanOutput" -ForegroundColor Cyan
      }
      else {
